/*============================================================
    "Cascade" theme programmatic settings
...
//----------------------------------------
    ...
    isc.Page.setSkinDir("[ISOMORPHIC]/skins/Cascade/")
...
//----------------------------------------
    ...
    // -----------------------------------------------------   
    // css3 and spriting are required for the Cascade skin
    var useCSS3 = isc.Browser.useCSS3,
        useSpriting = isc.Browser.useSpriting;
        
    if (!useCSS3 || !useSpriting) {
        isc.logWarn("The Cascade skin makes use of HTML5 features which may be " +
    ...
    if (isc.ListGrid) {
        isc.ListGrid.addProperties({
            ...
            sortAscendingImage:{src:"[SKINIMG]ListGrid/sort_ascending.png", width:14, height:7},
            sortDescendingImage:{src:"[SKINIMG]ListGrid/sort_descending.png", width:13, height:7},
        ...
        isc.ListGrid.changeDefaults("expansionDetailFieldDefaults", {
    ...
    if (isc.CheckboxItem) {
        ...
        isc.CheckboxItem.addProperties({
            ...
            // For Cascade, there is no default "unset" image
    ...
    if (isc.setCurrentSkin) {
        isc.setCurrentSkin("Cascade", "Flat", 
            // in the Showcase, use the icons/thumbnails/example images from the "Tahoe" skin
            { showcaseMediaSkin: "Tahoe" }
        );
    }
