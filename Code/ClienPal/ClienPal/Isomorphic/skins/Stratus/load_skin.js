/*============================================================
    "Stratus" theme programmatic settings
...
//----------------------------------------
    ...
    isc.Page.setSkinDir("[ISOMORPHIC]/skins/Stratus/")
...
//----------------------------------------
    ...
    // -----------------------------------------------------   
    // css3 and spriting are required for the Stratus skin
    var useCSS3 = isc.Browser.useCSS3,
        useSpriting = isc.Browser.useSpriting;
        
    if (!useCSS3 || !useSpriting) {
        isc.logWarn("The Stratus skin makes use of HTML5 features which may be " +
    ...
    if (isc.CheckboxItem) {
        ...
        isc.CheckboxItem.addProperties({
            ...
            // For Stratus, there is no default "unset" image
    ...
    if (isc.setCurrentSkin) isc.setCurrentSkin("Stratus", "Flat");
